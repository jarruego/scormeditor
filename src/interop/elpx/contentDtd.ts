/**
 * `content.dtd` de eXeLearning (ODE 2.0), incrustado VERBATIM del repositorio
 * oficial (github.com/exelearning/exelearning, public/app/schemas/ode/content.dtd,
 * AGPL-3.0). El `.elpx` lo referencia con <!DOCTYPE ode SYSTEM "content.dtd">;
 * el validador oficial y el importador lo esperan en la raiz del paquete.
 */
...
<!--
    ...
    - external-website, casestudy, etc.
-->
